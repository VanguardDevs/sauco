...
@section('title', 'Registro de Ordenanzas y Licencias')
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head alert alert-danger">
                    <div class="kt-portlet__head-label">
                        ...
                        @if ($typeForm == 'create')
                            Registro de Ordenanzas y Licencias
                       @else
                            Editar ordenanza: {{ @$row->login }}
                       @endif
                        </h3>
                    </div>
                </div>
                ...
                @endif
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="{{ url('settings/ordinances') }}" class="btn btn-secondary" id="cancel"><i class="fas fa-reply"></i> Regresar</a>
