...
class LiqueurParameterSeeder extends Seeder
{
    ...
    protected $rows = Array(
        ...
        ["1", "Expendios de Bebidas Alchólicas en Zonas Urbanas", "0.1", "0.3", "1", false, "1", "1", "2"],



        ["2", "Expendios de Bebidas Alchólicas en Zonas Sub Urbanas", "0.1", "0.3", "0.5", false, "1", "2", "2"],
