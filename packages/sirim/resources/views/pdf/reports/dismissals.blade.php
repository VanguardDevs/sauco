    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="tables">
                ...
                <br>
                <div class="row" style="text-align: justify;">
                    <u>Segundo:</u> Notifiquese del presente acto al ciudadano(a) {{ $license->representation->person->name }}, C.I {{ $license->representation->person->document }} en su carácter de Representante Legal del Fondo de Comercio {{ $license->taxpayer->commercialDenomination->name }}.
                </div>
                <br>
                <div class="row firma">
